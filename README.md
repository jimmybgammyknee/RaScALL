...
1. To install and run the km script we'll need to create a conda environment for installation of km and jellyfish. Jellyfish needs additional python bindings to work with km, so we have created an install procedure to follow. This procedure requires that the command-line utility 'curl' be installed on your machine.
...
```
git clone https://github.com/sagc-bioinformatics/RaScALL.git
```
